  ...
  cc.Popup = (function() {
    ...
    var defaultOptions = {
      ...
      elements: {
        ...
        messagelink: '<span id="cookieconsent:desc" class="cc-message">{{message}} <a aria-label="learn more about cookies" role=button tabindex="0" class="cc-link" href="{{href}}" target="{{target}}">{{link}}</a></span>',
